...
Listedevilldecharlatan = [["marseille",1,2],["lyon",1,2],["paris",1,18]]
...
try:
    for nomville in Listedevilldecharlatan:
        for page in range(nomville[1],nomville[2]):
            ...
            driver.get("https://www.doctolib.fr/chiropracteur/"+str(nomville[0])+"?page="+str(page))
            print("\n URL ENTREE : https://www.doctolib.fr/chiropracteur/"+str(nomville[0])+"?page="+str(page)+"\n")
    ...
    full_df.to_csv("chiropracteurville.csv",quoting=csv.QUOTE_ALL,quotechar='"')
...
full_df.head()
full_df.to_csv("chiropracteurvile.csv",quoting=csv.QUOTE_ALL)
full_df.to_excel("chiropracteurville.xlsx" )
