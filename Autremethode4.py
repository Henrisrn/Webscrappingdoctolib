...
try:
    for page in range(1,905):
        ...
        try:
            ...
            u = pd.read_json(StringIO(f[0].replace(">","").replace(chr(92),"")))
        except:
            continue
            time.sleep(20)
        time.sleep(10)
...
try:
    for page in range(391,528):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/psychologue/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
...
try:
    for page in range(1,46):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/chiropracteur/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
...
try:
    for page in range(1,177):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/dieteticien/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
...
try:
    for page in range(1,27):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/psychomotricien/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
...
try:
    for page in range(1,349):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/pedicure-podologue/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
...
try:
    for page in range(1,160):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/sophrologue/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
...
try:
    for page in range(1,273):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/hypnotherapeute/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
...
try:
    for page in range(1,117):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/psychanalyste/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
...
try:
    for page in range(1,85):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/naturopathe/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
...
try:
    for page in range(1,41):
        start_page=datetime.now()
        a = requests.get("https://www.doctolib.fr/acupuncteur/france?page="+str(page))
        soup = BeautifulSoup(a.text, 'html.parser')
        my_bytes = str(soup.encode('utf-8'))
        try:
            e = my_bytes.split('<script type="application/ld+json"')
